     ...
     $.fn.tipuesearch = function(options) {
          ...
          return this.each(function() {
               ...
               if (set.mode == 'live')
               {
                    ...
                    {
                         $.get('/convert/'+tipuesearch_pages[i], '',
                              function (html)
                              {
               ...
               function trim_head(text) {
                   var l = 0, temp = text.split(/\r|\n/);
                   for (var i in temp) {
                       if (temp[i][0] === '#') {
                           l = i;
                           break;
                   ...
                   return qa_parse(temp.slice(l, temp.length).join('\n'));
               }
               ...
               function getTipueSearch(start, replace)
               {
                    ...
                    if (d.length >= set.minimumLength)
                    {
                         ...
                         for (var i = 0; i < tipuesearch_in.pages.length; i++)
                         {
                              ...
                              var temp = trim_head(tipuesearch_in.pages[i].text);
                              var s_t = temp;
